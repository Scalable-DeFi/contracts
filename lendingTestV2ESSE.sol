...
contract lending is Ownable {
    ...
    function howMuchShouldIPayLate(uint256 _id, uint256 whenYouShouldHavePaid) public view returns(uint256) {
        ...
        uint256 amount = ((Loans[_id].withdrawnAmount / paymentFrequency) + ((Loans[_id].withdrawnAmount * interestRate / 100) / paymentFrequency) + (((Loans[_id].withdrawnAmount * lateFee / 1000) * (block.timestamp - whenYouShouldHavePaid)) / 86400));
        return(amount);
    }
